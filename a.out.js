...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 587344,
    DYNAMIC_BASE = 5830224,
    DYNAMICTOP_PTR = 587184;
...
var ASM_CONSTS = {
  1024: function($0) {drawFrame($0);},  
 1045: function($0, $1) {writeAudio($0, $1);},  
 1081: function() {wasmReady();}
};
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_current=587200;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 587248, 4), 587248);
...
var real__loadRom = asm["loadRom"];
asm["loadRom"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__loadRom.apply(null, arguments);
};

var real__updateSaveBufState = asm["updateSaveBufState"];
asm["updateSaveBufState"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__updateSaveBufState.apply(null, arguments);
};

var real__getSaveBuf = asm["getSaveBuf"];
asm["getSaveBuf"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__getSaveBuf.apply(null, arguments);
};

var real__runFrame = asm["runFrame"];
asm["runFrame"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__runFrame.apply(null, arguments);
};

var real__resetCpu = asm["resetCpu"];
asm["resetCpu"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__resetCpu.apply(null, arguments);
};
...
var _loadRom = Module["_loadRom"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["loadRom"].apply(null, arguments)
};

var _updateSaveBufState = Module["_updateSaveBufState"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["updateSaveBufState"].apply(null, arguments)
};

var _getSaveBuf = Module["_getSaveBuf"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["getSaveBuf"].apply(null, arguments)
};

var _runFrame = Module["_runFrame"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["runFrame"].apply(null, arguments)
};

var _resetCpu = Module["_resetCpu"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["resetCpu"].apply(null, arguments)
};
